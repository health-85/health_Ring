...
public class BubbleConfigBuilder {
    ...
    public BubbleConfigBuilder trackSize(int dp) {
        this.trackSize = DeviceUtil.dip2px(MyApplication.Companion.instance(), dp);
        return this;
    }

    public BubbleConfigBuilder secondTrackSize(int dp) {
        this.secondTrackSize = DeviceUtil.dip2px(MyApplication.Companion.instance(),dp);
        return this;
    }

    public BubbleConfigBuilder thumbRadius(int dp) {
        this.thumbRadius = DeviceUtil.dip2px(MyApplication.Companion.instance(),dp);
        return this;
    }

    public BubbleConfigBuilder thumbRadiusOnDragging(int dp) {
        this.thumbRadiusOnDragging = DeviceUtil.dip2px(MyApplication.Companion.instance(),dp);
        return this;
    }
    ...
    public BubbleConfigBuilder sectionTextSize(int sp) {
        this.sectionTextSize = DeviceUtil.sp2px(MyApplication.Companion.instance(),sp);
        return this;
    }
    ...
    public BubbleConfigBuilder thumbTextSize(int sp) {
        this.thumbTextSize = DeviceUtil.sp2px(MyApplication.Companion.instance(),sp);
        return this;
    }
    ...
    public BubbleConfigBuilder bubbleTextSize(int sp) {
        this.bubbleTextSize = DeviceUtil.sp2px(MyApplication.Companion.instance(),sp);
        return this;
    }
