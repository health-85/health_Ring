 ...
 * @Description: Rvigor
 * @Author: wb
 * @CreateDate: 2024/5/14 11:29
 * @UpdateRemark:
 */
@Entity
public class HeartRateDBEntity {
...
//    public boolean isOneMin;
    ...
    @Generated(hash = 19927008)
    public HeartRateDBEntity(Long id, long uid, int isupLoadToServer,
