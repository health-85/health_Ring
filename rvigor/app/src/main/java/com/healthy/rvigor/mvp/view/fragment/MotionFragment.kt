...
import com.healthy.rvigor.databinding.FragmentMotionBinding
import com.healthy.rvigor.event.WatchDataEvent
import com.healthy.rvigor.mvp.contract.IMotionContract
import com.healthy.rvigor.mvp.presenter.MotionPresenter
 ...
 * @UpdateRemark:
 */
class MotionFragment : BaseMVPFragment<FragmentMotionBinding, MotionPresenter>(), IMotionContract.View{
    ...
    private val mPageAdapter by lazy {
        SmartViewPager2Adapter(this, binding!!.viewPager)
            ...
            .addFragment(1, MotionItemFragment::class.java)
//            .addData(
//                SourceBean(
//                    0,
//                    1,
...
//            )
    ...
    override fun createPresenter(): MotionPresenter {
...
//                }, 1000)
        ...
        binding?.viewPager?.registerOnPageChangeCallback(object :
            ...
            override fun onPageSelected(position: Int) {
                ...
                watchDataEvent.type = Constants.MOTION_TYPE
    ...
    override fun onHiddenChanged(hidden: Boolean) {
        ...
        val curDay = SPUtil.getData(MyApplication.instance(), SpConfig.IS_MOTION_CURRENT_DAY, 0L)
        if (curDay != day) {
            addPagerData()
    ...
    private fun addPagerData() {
        ...
        val day = DateTimeUtils.getDateTimeDatePart(Date(System.currentTimeMillis())).time
        SPUtil.saveData(MyApplication.instance(), SpConfig.IS_MOTION_CURRENT_DAY, day)
