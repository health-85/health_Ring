 ...
 * siat手表血氧数据同步
 */
public class InsertSpoExecutor extends AppDaoManager.DBExecutor {
    ...
    public InsertSpoExecutor(SpoInfo spoInfo, String deviceName, String deviceMacAddress) {
        this.spoInfo = spoInfo;
        this.deviceName = deviceName;
        this.deviceMacAddress = deviceMacAddress;
    }

    public InsertSpoExecutor(SpoInfo spoInfo, String deviceName, String deviceMacAddress, boolean isSleepOx) {
        this.spoInfo = spoInfo;
